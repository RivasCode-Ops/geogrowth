        ...
        <>
          ...
          {showForm ? (
            ...
            <Card
              ...
              title={editingItem ? 'Editar parceria' : 'Nova parceria'}
            ...
            <Card title="Filtros" flushTop>
              ...
              <div className="filter-bar">
                ...
                <label className="filter-bar__label" htmlFor="partnerships-type-filter">
          ...
          {isLoading ? (
            ...
            <Card title="Parcerias cadastradas" flushTop>
